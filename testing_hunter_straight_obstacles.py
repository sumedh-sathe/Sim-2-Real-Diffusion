...
image_folder = os.path.join(script_dir, "input_hunter_straight_obstacles") # Load input frames from here
style_folder = os.path.join(script_dir, "style_autodrive_large_offroad") # Load style frames from here
output_folder = os.path.join(script_dir, "output_hunter_straight_obstacles") # Store output results here
