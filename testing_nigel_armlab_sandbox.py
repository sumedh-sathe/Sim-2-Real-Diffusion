...
image_folder = os.path.join(script_dir, "input_nigel_armlab_sandbox") # Load input frames from here
style_folder = os.path.join(script_dir, "style_autodrive_small_onroad") # Load style frames from here
output_folder = os.path.join(script_dir, "output_nigel_armlab_sandbox") # Store output results here
